...
knitr::opts_knit$set(root.dir = here::here("~/projects/2024_working_group/code"))
...
# Create folders to link into                                  
assembly_paths$new_path %>% dirname() %>% unique() %>%  fs::dir_create()
